    ...
    deleteVendor = () => {
      return new Promise((resolve, reject) => {
        if (typeof config.delete.vendorJs === 'undefined') {
          ...
          //   let lastChar = vendorJs[4].substr(vendorJs[4].length - 1),
          //     index;
          //   if (lastChar === '\n') {
          //     index = vendorJs.indexOf(item + '\n');
          //   } else {
          //     index = vendorJs.indexOf(item);
          //   }

          //   if (index > 1) {
          //     vendorJs.splice(index, 1);
          //   }
          // }
          //     try {
          //       fs.writeFileSync(path, vendorJs.join().replace(/,/g, ''), 'utf8');
          //       resolve();
          //     } catch (e) {
          //       console.log(e);
          //       reject();
