  ...
  return new Promise((resolve, reject) => {
    ...
    if (method === 'delete') {
      instructions = (object, field) => {
        // Change to object
        return new Promise((resolve, reject) => {
          console.log(`Delete dependencies: ${typeof object[field] === 'undefined'}`.red);
      ...
      instructions = (object, field) => {
        // Change to object
        return new Promise((resolve, reject) => {
          console.log(`Add dependencies: ${typeof object[field] === 'undefined'}`.red);
          if (typeof object[field] === 'undefined') {
            resolve();
          } else {
